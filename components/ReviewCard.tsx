...
export function ReviewCard({ name, rating, text, location, service }: ReviewCardProps) {
  ...
  return (
    <article className="group w-full rounded-[2rem] border border-amber-100/80 bg-white p-6 shadow-[0_18px_50px_rgba(120,53,15,0.1)] transition duration-300 hover:-translate-y-2 hover:shadow-[0_24px_65px_rgba(120,53,15,0.16)]">
      <div className="flex min-w-0 items-start justify-between gap-4 max-sm:gap-2">
        ...
        <div className="shrink-0 rounded-full bg-orange-50 px-3 py-2 text-orange-500 shadow-inner max-sm:px-2 max-sm:py-1">
